...
class AssetViewSet(BaseModelViewSet):
    ...
    def update(self, request, *args, **kwargs):
        ...
        if (
                data.get('classify_id')
                and data.get('classify_id') != instance.classify.id
        ):
    ...
    def bind(self, request, *args, **kwargs):
        ...
        parent_asset_obj = OperateInstance.get_asset(
            parent_asset_id
        )
        child_asset_obj = OperateInstance.get_asset(
            child_asset_id
        )
    ...
    def un_bind(self, request, *args, **kwargs):
        ...
        try:
            record('un_bind', asset_bind_obj.parent_asset, asset_bind_obj.child_asset, request)
        except Exception as e:
            return json_error_response(f'日志记录出错: {str(e)}')
